...
},updateViewLockState:function(){if((typeof parent.isLocked==="function")&&(typeof parent.isLockedByCurrentUser==="function")){var a=parent.isLocked();
var b=parent.isLockedByCurrentUser();
var c=ORYX.READONLY||ORYX.VIEWLOCKED;
